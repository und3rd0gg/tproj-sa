...
namespace Obi
{
    ...
    {
        private static GUIStyle separatorLine;
        private static GUIStyle toggleablePropertyGroup;
        private static GUIStyle boldToggle;
        ...
        public static void SaveMesh(Mesh mesh, string title, string name, bool makeNewInstance = true,
            bool optimizeMesh = true)
        {
            var path = EditorUtility.SaveFilePanel(title, "Assets/", name, "asset");
        ...
        public static void PlaceActorRoot(GameObject element, MenuCommand menuCommand)
        {
            ...
            if (parent == null) parent = GetOrCreateSolverObject();
        ...
        private static GameObject GetOrCreateSolverObject()
        {
            ...
            var solver = selectedGo != null ? selectedGo.GetComponentInParent<ObiSolver>() : null;
            ...
            var solverArray = StageUtility.GetCurrentStageHandle().FindComponentsOfType<ObiSolver>();
            for (var i = 0; i < solverArray.Length; i++)
        ...
        public static GameObject CreateNewSolver()
        {
            ...
            var solver = root.AddComponent<ObiSolver>();
            ...
            var updater = StageUtility.GetCurrentStageHandle().FindComponentOfType<ObiFixedUpdater>();
        ...
        private static bool IsValidSolver(ObiSolver solver)
        {
        ...
        public static void DoPropertyGroup(GUIContent content, Action action)
        {
        ...
        public static void DoToggleablePropertyGroup(SerializedProperty enabledProperty, GUIContent content,
            Action action)
        {
            ...
            GUI.enabled = enabled;
            {
                ...
                enabledProperty.boolValue =
                    EditorGUILayout.ToggleLeft(content, enabledProperty.boolValue, EditorStyles.boldLabel);
                EditorGUILayout.EndHorizontal();
        ...
        public static int DoToolBar(int selected, GUIContent[] items)
        {
            ...
            var style = GUI.skin.FindStyle("Button");
            ...
            for (var i = 0; i < items.Length; i++)
            {
                ...
                var change = GUILayout.Toggle(selected == i, items[i], style, GUILayout.Height(24));
