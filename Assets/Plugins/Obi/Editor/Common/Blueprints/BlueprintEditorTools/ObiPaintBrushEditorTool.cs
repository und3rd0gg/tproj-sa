...
namespace Obi
{
    public class ObiPaintBrushEditorTool : ObiBlueprintEditorTool
    {
        ...
        /**<index of the property to copy from*/
        ...
        {
            return
                "Paint particle properties directly on the mesh. Most brushes have an alternate mode, accesed by holding 'shift' while painting.";
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (paintBrush.brushMode is ObiFloatCopyBrushMode)
            {
                ...
                if (EditorGUI.EndChangeCheck()) (paintBrush.brushMode as ObiFloatCopyBrushMode).source = sourceProperty;
            ...
            paintBrush.mirror.axis =
                (ObiBrushMirrorSettings.MirrorAxis) EditorGUILayout.EnumPopup("Brush mirror axis",
                    paintBrush.mirror.axis);
            paintBrush.mirror.space =
                (ObiBrushMirrorSettings.MirrorSpace) EditorGUILayout.EnumPopup("Brush mirror space",
                    paintBrush.mirror.space);

            EditorGUI.BeginChangeCheck();
            meshBasedEditor.particleCulling =
