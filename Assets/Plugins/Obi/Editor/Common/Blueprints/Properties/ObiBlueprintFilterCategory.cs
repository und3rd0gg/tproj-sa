namespace Obi
{
    public class ObiBlueprintFilterCategory : ObiBlueprintIntProperty
    {
        ...
        public ObiBlueprintFilterCategory(ObiActorBlueprintEditor editor) : base(ObiUtils.MinCategory,
            ObiUtils.MaxCategory)
        {
            this.editor = editor;
        ...
        {
            editor.blueprint.filters[index] =
                ObiUtils.MakeFilter(ObiUtils.GetMaskFromFilter(editor.blueprint.filters[index]), value);
        }
