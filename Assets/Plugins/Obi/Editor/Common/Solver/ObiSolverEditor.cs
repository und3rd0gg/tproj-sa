...
namespace Obi
{
     ...
     */
    [CustomEditor(typeof(ObiSolver))]
    [CanEditMultipleObjects]
    public class ObiSolverEditor : Editor
    {
        private SerializedProperty backend;
        private SerializedProperty bendingConstraintParameters;
        private SerializedProperty bendTwistConstraintParameters;
        private SerializedProperty chainConstraintParameters;
        private SerializedProperty collisionConstraintParameters;
        private BooleanPreference collisionsFoldout;

        private GUIContent constraintLabelContent;
        private BooleanPreference constraintsFoldout;
        private SerializedProperty densityConstraintParameters;

        private SerializedProperty distanceConstraintParameters;
        private SerializedProperty frictionConstraintParameters;
        private SerializedProperty gravity;
        private SerializedProperty gravitySpace;
        private SerializedProperty parameters;
        private SerializedProperty particleCollisionConstraintParameters;
        private SerializedProperty particleFrictionConstraintParameters;
        private SerializedProperty pinConstraintParameters;
        private SerializedProperty shapeMatchingConstraintParameters;
        private SerializedProperty simulateWhenInvisible;
        private BooleanPreference simulationFoldout;
        private SerializedProperty skinConstraintParameters;

        private ObiSolver solver;

        private BooleanPreference solverFoldout;
        private SerializedProperty stitchConstraintParameters;
        private SerializedProperty stretchShearConstraintParameters;
        private SerializedProperty tetherConstraintParameters;
        private SerializedProperty volumeConstraintParameters;
        private SerializedProperty worldAngularInertiaScale;
        private SerializedProperty worldLinearInertiaScale;
        ...
        public void OnEnable()
        {
            ...
            particleCollisionConstraintParameters =
                serializedObject.FindProperty("particleCollisionConstraintParameters");
            particleFrictionConstraintParameters =
                serializedObject.FindProperty("particleFrictionConstraintParameters");
        ...
        private static void CreateObiSolver(MenuCommand menuCommand)
        {
            var go = ObiEditorUtils.CreateNewSolver();
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (solverFoldout)
            {
                ...
                if (backend.enumValueIndex == (int) ObiSolver.BackendType.Burst)
                    EditorGUILayout.HelpBox(
                        "The Burst backend depends on the following packages: Mathematics, Collections, Jobs and Burst. The default backend (Oni) will be used instead, if possible.",
                        MessageType.Warning);
#endif
            ...
            constraintsFoldout.value =
                EditorGUILayout.BeginFoldoutHeaderGroup(constraintsFoldout, "Constraint settings");
        ...
        private static void DrawGizmoForSolver(ObiSolver solver, GizmoType gizmoType)
        {
