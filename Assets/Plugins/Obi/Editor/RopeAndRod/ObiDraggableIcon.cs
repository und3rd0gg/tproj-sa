        ...
        public static bool Draw(bool selected, int id, ref Vector2 position, Color color)
        {
            ...
            switch (Event.current.GetTypeForControl(controlID))
            {
                case EventType.MouseDown:
                    ...
                    var area = new Rect(position.x - 5, position.y - 5, 10, 10);
                    ...
                    else if ((Event.current.modifiers & EventModifiers.Shift) == 0 &&
                ...
                case EventType.Repaint:
                    ...
                    GUI.color = selected
                        ? ObiEditorSettings.GetOrCreateSettings().selectedParticleColor
                        : ObiEditorSettings.GetOrCreateSettings().particleColor;
                    var rect = new Rect(position.x - 2, position.y - 2, 4, 4);
