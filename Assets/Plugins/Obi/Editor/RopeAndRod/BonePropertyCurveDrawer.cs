...
namespace Obi
{
    ...
    public class BonePropertyCurveDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var curveFieldWidth = (position.width - EditorGUIUtility.labelWidth) * 0.5f;
            ...
            var curveRect = new Rect(position.x + position.width - curveFieldWidth + 3, position.y, curveFieldWidth - 3,
                position.height);
            EditorGUI.CurveField(curveRect, property.FindPropertyRelative("curve"), Color.green, new Rect(0, 0, 1, 1),
                GUIContent.none);
