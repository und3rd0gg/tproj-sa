...
namespace Obi
{
    ...
    {
        private ObiRope actor;
        private SerializedProperty bendCompliance;

        private SerializedProperty bendConstraintsEnabled;

        private SerializedProperty collisionMaterial;

        private SerializedProperty distanceConstraintsEnabled;

        private GUIStyle editLabelStyle;
        private SerializedProperty maxBending;
        private SerializedProperty maxCompression;
        private SerializedProperty plasticCreep;
        private SerializedProperty plasticYield;

        private SerializedProperty ropeBlueprint;
        private SerializedProperty selfCollisions;
        private SerializedProperty stretchCompliance;
        private SerializedProperty stretchingScale;
        private SerializedProperty surfaceCollisions;

        private SerializedProperty tearingEnabled;
        private SerializedProperty tearRate;
        private SerializedProperty tearResistanceMultiplier;
        ...
        private static void CreateObiRope(MenuCommand menuCommand)
        {
            var go = new GameObject("Obi Rope", typeof(ObiRope), typeof(ObiRopeExtrudedRenderer));
        ...
        public override void OnInspectorGUI()
        {
            ...
            ObiEditorUtils.DoToggleablePropertyGroup(distanceConstraintsEnabled,
                new GUIContent("Distance Constraints", Resources.Load<Texture2D>("Icons/ObiDistanceConstraints Icon")),
                () =>
                {
            ...
            ObiEditorUtils.DoToggleablePropertyGroup(bendConstraintsEnabled,
                new GUIContent("Bend Constraints", Resources.Load<Texture2D>("Icons/ObiBendConstraints Icon")),
                () =>
                {
        ...
        private static void DrawGizmos(ObiRope actor, GizmoType gizmoType)
        {
            ...
            if (actor.ropeBlueprint != null)
                ObiPathHandles.DrawPathHandle(actor.ropeBlueprint.path, actor.transform.localToWorldMatrix,
                    actor.ropeBlueprint.thickness, 20, false);
        }
    }
}