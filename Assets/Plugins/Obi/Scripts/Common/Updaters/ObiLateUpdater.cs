...
{
    /// <summary>
    ///     Updater class that will perform simulation during LateUpdate(). This is highly unphysical and should be avoided
    ///     whenever possible.
    ...
    {
        /// <summary>
        ///     Smoothing factor fo the timestep (smoothDelta). Values closer to 1 will yield stabler simulation, but it will be
        ///     off-sync with rendering.
        /// </summary>
        [Tooltip(
        ...
        /// <summary>
        ///     Target timestep used to advance the simulation. The updater will interpolate this value with Time.deltaTime to find
        ///     the actual timestep used for each frame.
        /// </summary>
        [Tooltip(
        ...
        private void LateUpdate()
        {
            if (Time.deltaTime > 0)
            {
                if (Application.isPlaying)
                {
                    ...
                    var substepDelta = smoothDelta / substeps;
