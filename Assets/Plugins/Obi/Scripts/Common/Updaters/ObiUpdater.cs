...
namespace Obi
{
    ...
    {
        private static ProfilerMarker m_BeginStepPerfMarker = new ProfilerMarker("BeginStep");
        private static ProfilerMarker m_SubstepPerfMarker = new ProfilerMarker("Substep");
        private static ProfilerMarker m_EndStepPerfMarker = new ProfilerMarker("EndStep");
        private static ProfilerMarker m_InterpolatePerfMarker = new ProfilerMarker("Interpolate");
        ...
        private readonly List<IObiJobHandle> handles = new List<IObiJobHandle>();
