...
namespace Obi
{
 ...
 colliderToSolver.TransformPointUnscaled(center + normal * (radius + shape.contactOffset));
                             ...
                             float optimizationTolerance)
        {
            ...
            var colliderPoint =
 BurstLocalOptimization.Optimize<BurstSphereQuery>(ref this, positions, orientations, radii, simplices, simplexStart, simplexSize,
