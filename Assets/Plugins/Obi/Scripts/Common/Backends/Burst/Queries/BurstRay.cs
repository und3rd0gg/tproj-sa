...
namespace Obi
{
    public struct BurstRay : BurstLocalOptimization.IDistanceFunction
    {
        ...
        public void Evaluate(float4 point, float4 radii, quaternion orientation, ref BurstLocalOptimization.SurfacePoint projectedPoint)
        {
            ...
            float4x4 colliderToSimplex =
 math.mul(solverToSimplex, float4x4.TRS(colliderToSolver.translation.xyz, colliderToSolver.rotation, colliderToSolver.scale.xyz));
            ...
            float4 rayDirection =
 math.normalizesafe(math.mul(colliderToSimplex, new float4((shape.size - shape.center).xyz,0)));
            ...
            if (rayDistance < 0)
            {
                ...
                float4 centerLine =
 BurstMath.NearestPointOnEdge(shape.center * colliderToSolver.scale, shape.size * colliderToSolver.scale, point, out float mu);
 ...
 colliderToSolver.TransformPointUnscaled(centerLine + normal * shape.contactOffset);
                             ...
                             float optimizationTolerance)
        {
            ...
            var colliderPoint =
 BurstLocalOptimization.Optimize<BurstRay>(ref this, positions, orientations, radii, simplices, simplexStart, simplexSize,
