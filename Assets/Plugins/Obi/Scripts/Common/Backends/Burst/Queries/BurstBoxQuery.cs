...
namespace Obi
{
 ...
 colliderToSolver.TransformPointUnscaled(projectedPoint.point + center + projectedPoint.normal * shape.contactOffset);
                             ...
                             float optimizationTolerance)
        {
            ...
            var colliderPoint =
 BurstLocalOptimization.Optimize<BurstBoxQuery>(ref this, positions, orientations, radii, simplices, simplexStart, simplexSize,
