namespace Obi
{
    public interface IColliderWorldImpl
    {
        ...
        void SetColliders(ObiNativeColliderShapeList shapes, ObiNativeAabbList bounds,
        ...
        void SetTriangleMeshData(ObiNativeTriangleMeshHeaderList headers, ObiNativeBIHNodeList nodes,
            ObiNativeTriangleList triangles, ObiNativeVector3List vertices);

        void SetEdgeMeshData(ObiNativeEdgeMeshHeaderList headers, ObiNativeBIHNodeList nodes,
            ObiNativeEdgeList triangles, ObiNativeVector2List vertices);
