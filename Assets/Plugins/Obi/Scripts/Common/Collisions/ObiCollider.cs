...
namespace Obi
{
    ...
    {
        [SerializeProperty("sourceCollider")] [FormerlySerializedAs("SourceCollider")] [SerializeField]
        private Collider m_SourceCollider;

        [SerializeProperty("distanceField")] [FormerlySerializedAs("distanceField")] [SerializeField]
        ...
        public Collider sourceCollider
        {
            set
            {
                if (value != null && value.gameObject != gameObject)
                {
            ...
            get => m_SourceCollider;
        }

        /// <summary>
        ///     The distance field used by this collider.
        /// </summary>
        /// Setting a distance field will cause the collider to ignore its
        /// <see cref="m_SourceCollider" />
        /// and use the distance field instead.
