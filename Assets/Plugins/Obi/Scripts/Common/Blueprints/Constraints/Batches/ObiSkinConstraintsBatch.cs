...
namespace Obi
{
    ...
    public class ObiSkinConstraintsBatch : ObiConstraintsBatch
    {
        ...
        public void AddConstraint(int index, Vector4 point, Vector4 normal, float radius, float collisionRadius,
            float backstop, float stiffness)
        {
            RegisterConstraint();
        ...
        public override void AddToSolver(ObiSolver solver)
        {
            ...
            if (m_BatchImpl != null)
                m_BatchImpl.SetSkinConstraints(particleIndices, skinPoints, skinNormals, skinRadiiBackstop,
                    skinCompliance, lambdas, m_ActiveConstraintCount);
        }
