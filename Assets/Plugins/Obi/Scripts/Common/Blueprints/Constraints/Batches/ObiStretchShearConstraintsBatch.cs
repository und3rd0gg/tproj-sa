...
namespace Obi
{
    ...
    public class ObiStretchShearConstraintsBatch : ObiConstraintsBatch, IStructuralConstraintBatch
    {
        ...
        public override Oni.ConstraintType constraintType => Oni.ConstraintType.StretchShear;
        ...
        public void AddConstraint(Vector2Int indices, int orientationIndex, float restLength,
            Quaternion restOrientation)
        {
            RegisterConstraint();
        ...
        public override void Merge(ObiActor actor, IObiConstraintsBatch other)
        {
            ...
            if (batch != null && user != null)
            {
                ...
                restOrientations.CopyFrom(batch.restOrientations, 0, m_ActiveConstraintCount,
                ...
                for (var i = 0; i < batch.activeConstraintCount * 2; ++i)
        ...
        public override void AddToSolver(ObiSolver solver)
        {
            ...
            m_BatchImpl =
                solver.implementation.CreateConstraintsBatch(constraintType) as IStretchShearConstraintsBatchImpl;

            if (m_BatchImpl != null)
                m_BatchImpl.SetStretchShearConstraints(particleIndices, orientationIndices, restLengths,
                    restOrientations, stiffnesses, lambdas, m_ActiveConstraintCount);
        }
