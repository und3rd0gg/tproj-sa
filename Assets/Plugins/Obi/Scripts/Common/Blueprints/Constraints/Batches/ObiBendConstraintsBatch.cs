    ...
    public class ObiBendConstraintsBatch : ObiConstraintsBatch
    {
        ...
        public override void Merge(ObiActor actor, IObiConstraintsBatch other)
        {
            ...
            if (batch != null && user != null)
            {
                ...
                bendingStiffnesses.CopyReplicate(new Vector2(user.maxBending, user.bendCompliance),
                    m_ActiveConstraintCount, batch.activeConstraintCount);
                plasticity.CopyReplicate(new Vector2(user.plasticYield, user.plasticCreep), m_ActiveConstraintCount,
                    batch.activeConstraintCount);

                for (var i = 0; i < batch.activeConstraintCount * 3; ++i)
        ...
        public override void AddToSolver(ObiSolver solver)
        {
            ...
            if (m_BatchImpl != null)
                m_BatchImpl.SetBendConstraints(particleIndices, restBends, bendingStiffnesses, plasticity, lambdas,
