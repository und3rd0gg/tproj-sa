...
namespace Obi
{
    ...
    public class ObiTetherConstraintsBatch : ObiConstraintsBatch
    {
        ...
        public override void Merge(ObiActor actor, IObiConstraintsBatch other)
        {
            ...
            if (batch != null && user != null)
            {
                ...
                for (var i = 0; i < batch.activeConstraintCount; ++i)
                    maxLengthsScales[m_ActiveConstraintCount + i] =
                        new Vector2(batch.maxLengthsScales[i].x, user.tetherScale);
        ...
        public override void AddToSolver(ObiSolver solver)
        {
            ...
            if (m_BatchImpl != null)
                m_BatchImpl.SetTetherConstraints(particleIndices, maxLengthsScales, stiffnesses, lambdas,
        ...
        {
            for (var i = 0; i < stiffnesses.count; i++)
            {
