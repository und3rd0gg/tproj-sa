...
namespace Obi
{
    ...
    public class ObiBendTwistConstraintsBatch : ObiConstraintsBatch
    {
        ...
        public override void AddToSolver(ObiSolver solver)
        {
            ...
            m_BatchImpl =
                solver.implementation.CreateConstraintsBatch(constraintType) as IBendTwistConstraintsBatchImpl;

            if (m_BatchImpl != null)
                m_BatchImpl.SetBendTwistConstraints(particleIndices, restDarbouxVectors, stiffnesses, plasticity,
