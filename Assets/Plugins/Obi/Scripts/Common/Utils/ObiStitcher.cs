...
namespace Obi
{
    ...
    public class ObiStitcher : MonoBehaviour
    {
        ...
        [SerializeField] [HideInInspector] private ObiActor actor1;

        /**< one of the actors used by the stitcher.*/
        [SerializeField] [HideInInspector] private ObiActor actor2;

        /**< the second actor used by the stitcher.*/
        ...
        private void AddToSolver(ObiSolver solver)
        {
            if (!inSolver)
            {
                ...
                m_BatchImpl =
                    solver.implementation.CreateConstraintsBatch(Oni.ConstraintType.Stitch) as
                        IStitchConstraintsBatchImpl;
